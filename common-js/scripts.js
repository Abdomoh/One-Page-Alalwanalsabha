	...
	if(isExists('#normal-countdown')){
		...
		$('#normal-countdown').countdown(date, function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="time-sec"><h3 class="main-time">%D</h3> <span>يوم</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">%H</h3> <span>ساعة</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">%M</h3> <span>دقيقة</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">%S</h3> <span>ثانية</span></div>'));
		});
	}
